...
<div class="user_tabs">
    <ul class="tab">
        ...
        <li class="c_tab"><a href="setting.php">Settings</a></li>
    </ul>
</div>
...
<div class="container setting">
    ...
    <p>your under in passmate guideline and <a href="admin\PrivacyPolicy\privacy.php">Term&Condition</a> and <a href="#">privacy policy</a>.</p>
